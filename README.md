# [DEPRECATED] Iterable Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_iterable`](https://github.com/fivetran/dbt_iterable) instead, which now contains all models previously found here._
