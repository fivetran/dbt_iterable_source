...
{% set columns = [
    ...
    {"name": "from_phone_number_id", "datatype": dbt_utils.type_int()},
    {"name": "from_smssender_id", "datatype": dbt_utils.type_int()},
    ...
    {"name": "sms_provider_response_code", "datatype": dbt_utils.type_int()},
    ...
    {"name": "sms_provider_response_status", "datatype": dbt_utils.type_int()},
