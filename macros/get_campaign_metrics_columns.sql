...
{% set columns = [
    ...
    {"name": "total_email_holdout", "datatype": dbt_utils.type_int()},
    {"name": "total_email_opens", "datatype": dbt_utils.type_float()},
    {"name": "total_email_send_skips", "datatype": dbt_utils.type_int()},
    {"name": "total_email_sends", "datatype": dbt_utils.type_float()},
    {"name": "total_hosted_unsubscribe_clicks", "datatype": dbt_utils.type_float()},
    {"name": "total_in_app_clicks", "datatype": dbt_utils.type_int()},
    {"name": "total_in_app_closes", "datatype": dbt_utils.type_int()},
    {"name": "total_in_app_deletes", "datatype": dbt_utils.type_int()},
    {"name": "total_in_app_holdout", "datatype": dbt_utils.type_int()},
    {"name": "total_in_app_opens", "datatype": dbt_utils.type_int()},
    {"name": "total_in_app_send_skips", "datatype": dbt_utils.type_int()},
    {"name": "total_in_app_sent", "datatype": dbt_utils.type_int()},
    {"name": "total_in_apps_delivered", "datatype": dbt_utils.type_int()},
    {"name": "total_inbox_impressions", "datatype": dbt_utils.type_int()},
    {"name": "total_purchases", "datatype": dbt_utils.type_float()},
    {"name": "total_push_holdout", "datatype": dbt_utils.type_int()},
    {"name": "total_push_send_skips", "datatype": dbt_utils.type_int()},
    ...
    {"name": "unique_email_sends", "datatype": dbt_utils.type_int()},
    {"name": "unique_emails_delivered", "datatype": dbt_utils.type_float()},
    {"name": "unique_emails_opens", "datatype": dbt_utils.type_int()},
    {"name": "unique_hosted_unsubscribe_clicks", "datatype": dbt_utils.type_float()},
    {"name": "unique_in_app_clicks", "datatype": dbt_utils.type_int()},
    {"name": "unique_in_app_opens", "datatype": dbt_utils.type_int()},
    {"name": "unique_in_app_sends", "datatype": dbt_utils.type_int()},
    {"name": "unique_in_apps_delivered", "datatype": dbt_utils.type_int()},
